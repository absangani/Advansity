...
<body>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center other-hero">
    <div class="container" data-aos="fade-in">
      <div class="row">
        ...
        <div id="home-section" class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch position-relative" data-aos="fade-right">
            <a href="https://youtu.be/krt6dFgS_b8" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <img src="assets/images/rev/DeepakSir.jpg" class="testimonial-img" alt="">
            <h3>Deepak Patil</h3>
          ...
          <div class="testimonial-item">
           ...
           <div class="testimonial-item">
            ...
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
              As we know world become digital, ADVANSITY IT WORLD is also giving it's share in making India digital. Heartly best best wishes to all Advansity team to make india digital. We appreciate the way Advansity work.
              <i class="bx bxs-quote-alt-right quote-icon-right"></i>
            </p>
          </div>
        </div>
