...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Why Us Section ======= -->
    <section id="services-us" class="services-us">
      <div class="container">
    ...
    <!-- business features -->
    <section class="features-business pb-0 section-bg">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 order-1 order-lg-2 order-md-2" data-aos="fade-right">
            <lottie-player class="SEO" src="https://assets9.lottiefiles.com/private_files/lf30_FHk7K8.json"  background="transparent"  speed="1"  style="width: auto; height: auto;"  loop autoplay></lottie-player>
    ...
    <section class="features-business section-bg">
      <div class="container">
        <div class="row align-items-center">
