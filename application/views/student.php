  ...
  <main id="main">
        ...
        <div class="row">
          <div class=" d-flex">
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row mb-5">
                <div class="col-xl-3 col-lg-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-xl-3 col-lg-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                  <div class="icon-box mt-4 mt-xl-0">
    ...
    <section id="testimonials" class="testimonials">
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-4">
            <h2 class="section-heading">Student Experience</h2>
          </div>
        </div>
          ...
          <div class="col-md-7">
            <div class="owl-carousel testimonials-carousel">
              <div class="testimonial-item review text-center">
                ...
                <p class="review-user">
                  <img src="assets/img/testimonials/testimonials-1.jpg" alt="Image" class="img-fluid rounded-circle mb-3">
                  <span class="d-block">
